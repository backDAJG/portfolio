  ...
  return (
    ...
    >
      ...
      >
        ...
        <stop offset=".454" stopColor="#0275ce" />
        <stop offset=".617" stopColor="#0472c7" />
        <stop offset=".733" stopColor="#076bbc" />
        <stop offset=".827" stopColor="#0d63ab" />
        <stop offset=".907" stopColor="#135895" />
        <stop offset=".933" stopColor="#16538c" />
      </linearGradient>
      <polygon
